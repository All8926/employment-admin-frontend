<template>
	<div class="flex flex-col gap-4">
		<el-card shadow="never">
			<el-form :model="queryParams" inline class="form-inline">
				...
				<el-form-item label="学号">
					<el-input v-model="queryParams.teacherNumber" placeholder="请输入学号"></el-input>
				</el-form-item>
		...
		<el-card shadow="never">
			...
			<el-table :data="tableData" style="width: 100%" :cell-style="{textAlign: 'center'}"
				...
				<el-table-column prop="teacherNumber" label="编号" />
    ...
    <TeacherModal :visible="visible" :title="modalTitle"  :cancel="(value) => handleVisible(value)" @submit="getList" :formData="currentRow" />
	</div>
</template>
...
const getList = async () => {
	const { data } = await teacherList(queryParams.value)
